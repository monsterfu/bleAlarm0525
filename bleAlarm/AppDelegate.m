...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSTimer* _dialingGapTimer = [NSTimer timerWithTimeInterval:1.0 target:self selector:@selector(test) userInfo:nil repeats:YES];
...
-(void)test
{
    [[ConnectionManager sharedInstance]scheduleCallingState:[AppDelegate App].callStateStr];
}
